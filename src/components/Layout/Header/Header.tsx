...
const Header = () => {
  ...
  const buttonLabels = ["Home", "About", "Project", "Fan", "Review", "Portfolio", "Apps", "Tech Curation"];
  const paths = ["/", "/about", "/project", `${baseDomain}/fan`, `${baseDomain}/review`, `${baseDomain}/portfolio`, `${baseDomain}/apps`, `${baseDomain}/tech_curation`];
