...
![read_it_later](../..../../blog/img/2022/read_it_later.png)
...
![Untitled](../..../../blog/img/2022/lifewiki.png)

주로 일상 생활에서의 내용에 대한 범용 카테고리다.

## 1. Retrospect

![retrospect_01.png](../..../../blog/img/2022/retrospect_01.png)

매일 하루 하루의 일과에 대한 기록을 남긴다.

![retrospect_02.png](../..../../blog/img/2022/retrospect_02.png)

30분 단위로 무엇을 했는지 기록한다.

![retropsect_template.png](../..../../blog/img/2022/retropsect_template.png)
...
![todo.png](../..../../blog/img/2022/todo.png)
...
![wishlist](../..../../blog/img/2022/wishlist.png)

# 3. Project

![project](../..../../blog/img/2022/project.png)
...
![works.png](../..../../blog/img/2022/works.png)
...
![company](../..../../blog/img/2022/company.png)
...
![journal01](../..../../blog/img/2022/journal01.png)

![journal02](../..../../blog/img/2022/journal02.png)
...
![dev_toy](../..../../blog/img/2022/dev_toy.png)
...
![dev_toy_overview](../..../../blog/img/2022/dev_toy_overview.png)

## 2. GM

1인 개발 중인 프로젝트에 대한 기획 문서와 정보들이다.

![gm](../..../../blog/img/2022/gm.png)

# 6. Develop

![develop](../..../../blog/img/2022/develop.png)
...
![general](../..../../blog/img/2022/general.png)

## 2. Human

조직, 자기 계발, 관리 등의 사람과 관계된 내용 들

![human](../..../../blog/img/2022/human.png)

## 3. Data

데이터베이스 등의 데이터 저장, 검색 등에 관련된 내용을 모아둔다

![data](../..../../blog/img/2022/data.png)

## 4. Game

게임 개발에 관련된 정보를 기록한다.

![game](../..../../blog/img/2022/game.png)

## 5. Web

웹 기술에 연관된 정보를 기록 한다.

![web](../..../../blog/img/2022/web.png)
...
![languages](../..../../blog/img/2022/languages.png)

## 7. Infra

Github, Git, AWS 등의 클라우드, OS (Linux, Windows 등), 배포 에 해당하는 내용 들을 정리한다.

![infra](../..../../blog/img/2022/infra.png)

# 7. Hobby

![hobby](../..../../blog/img/2022/hobby.png)
...
![hobby_game](../..../../blog/img/2022/hobby_game.png)

## 3. Watch

영화, 드라마 같은 보는 미디어에 대한 기록이다.

![watch](../..../../blog/img/2022/watch.png)

## 4. Read

독서 기록을 담는다.

![read](../..../../blog/img/2022/read.png)

## 5. Listen

모든 감상 기록을 담진 않는다. 그 해에 들었던 곡들 중 특별히 기억에 남는 곡들만 남긴다.

![listen](../..../../blog/img/2022/listen.png)

## 6. Gallery

모든 사진보다는 특별히 보기 쉽게 모아두는 사진들이다.

![gallery](../..../../blog/img/2022/gallery.png)

## 7. Draw

직접 그리거나 채색한 그림

![draw](../..../../blog/img/2022/draw.png)

## 8. Open Case

각종 물건들의 사진 모음이다.

![opencase](../..../../blog/img/2022/opencase.png)

## 9. Finance

금융 정보에 대한 클리핑이라고 보면 된다.

![finance](../..../../blog/img/2022/finance.png)

# 8. Private

![private](../..../../blog/img/2022/private.png)
...
![machine](../..../../blog/img/2022/machine.png)
...
![app_and_data](../..../../blog/img/2022/app_and_data.png)
...
![office](../..../../blog/img/2022/office.png)
